...
parser.add_argument('-r', '--result', default='../results', type=str)  # different from original code
parser.add_argument('--cpu', action="store_true", help='run on cpu')
parser.add_argument('--sample_method', default='', type=str)  # different from original code
parser.add_argument('--samples_batches', default='1', type=str)  # different from original code
parser.add_argument('--samples_per_samples_batch', default='', type=str)  # different from original code
parser.add_argument('--budget', default=-1, type=int)  # different from original code
